...
function create_system_inputfield() {
...
document.documentElement.querySelector("#eq_input").addEventListener("input", create_system_inputfield);                                                              
document.documentElement.querySelector("#var_input").addEventListener("input", create_system_inputfield);                                                                  
document.documentElement.querySelector("#btn_count").addEventListener("click", calculate);
